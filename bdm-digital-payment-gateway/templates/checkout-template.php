    ...
    <ul class="steps d-flex flex-column p-0 m-0">
        ...
        <li data-section="checkout" id="step-1" class="d-flex flex-column">
            ...
            <h3 class="d-flex align-items-center gap-2 m-0 mt-4 mb-4">
                <strong>
                    <?php esc_html_e( 'BDM Digital', 'bdm-checkout' ); ?>
                </strong>
                <img width="24" src="<?php echo plugin_dir_url( __FILE__ ) . '../assets/img/icon.png'; ?>" />          
            </h3>

            <div id="disclaimer" class="d-flex flex-column gap-3 p-4 mb-4">
                <img class="d-block me-auto" src="<?php echo plugin_dir_url( __FILE__ ) . '../assets/img/logo.png'; ?>" />  

                <p class="m-0"><strong><?php esc_html_e( 'Após a conclusão da compra, geraremos o código de pagamento em BDM DIGITAL.', 'bdm-checkout' ); ?></strong></p>
            ...
            <button id="bdm-checkout-button" class="btn btn-primary d-block m-auto col-12 col-sm-auto"><?php esc_html_e( 'Finalizar Pedido', 'bdm-checkout' ); ?></button>
        </li>

        <!-- Step 2: Payment Instructions -->
        <li data-section="billingcode" id="step-2" class="d-none flex-column gap-3">
            <h2 class="m-0"><?php esc_html_e( 'Efetue o pagamento para concluir.', 'bdm-checkout' ); ?></h2>
            <p class="m-0"><?php esc_html_e( 'Escaneie o QR code ou copie o código abaixo para realizar o pagamento em BDM DIGITAL.', 'bdm-checkout' ); ?><br/>
                <?php esc_html_e( 'O sistema irá reconhecer automaticamente a transferência.', 'bdm-checkout' ); ?>
                <br/><br/>
                <?php esc_html_e( 'O pagamento pode levar até 5 minutos para a confirmação.', 'bdm-checkout' ); ?>
            </p>
            ...
            <button id="bdm-copycode" class="btn btn-primary d-block m-auto col-12 col-sm-auto"><?php esc_html_e( 'Copiar Código', 'bdm-checkout' ); ?></button>
        </li>
        ...
        <li data-section="success" id="step-3" class="d-none flex-column justify-content-center align-items-center text-center gap-4">
            ...
            <h3 class="me-auto"><?php esc_html_e( 'Pagamento realizado com sucesso!', 'bdm-checkout' ); ?></h3>

            <img src="<?php echo plugin_dir_url( __FILE__ ) . '../assets/img/success.png'; ?>" />
            ...
            <p>
                <?php esc_html_e( 'Seu pagamento em BDM DIGITAL foi confirmado!', 'bdm-checkout' ); ?><br/><br/>
